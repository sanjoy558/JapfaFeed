                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                            gradient: LinearGradient(
                                colors: [statgradient2, Colors.red.withOpacity(0.5)]),
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        GestureDetector(
                          onTap: (){
                            trackCustomerController.goToListScreen("last_month_billed_customer");
                          },
                          child: Container(
                  ...
                  Stack(
                    children: [
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                            gradient: LinearGradient(
                                colors: [statgradient3, statgradient4.withOpacity(0.5)]),
                            border: Border.all(color: bordercolor1,width: 2.0),
                            borderRadius: BorderRadius.only(
                                topLeft: Radius.circular(10),
                                topRight: Radius.circular(10),
                            ...
                            children: [
                              Expanded(
                                child: GestureDetector(
                                  onTap: (){
                                    trackCustomerController.goToListScreen("current_month_billed");
                                  },
                                  child: Container(
                              ...
                              Expanded(
                                child: GestureDetector(
                                  onTap: (){
                                    trackCustomerController.goToListScreen("current_month_new_customer");
                                  },
                                  child: Container(
                                    padding: EdgeInsets.symmetric(vertical: 10.0),
                                    decoration: BoxDecoration(
                  ...
                  Stack(
                    children: [
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                            gradient: LinearGradient(
                                colors: [statgradient5, statgradient6.withOpacity(0.5)]),
                            border: Border.all(color: bordercolor1,width: 2.0),
                            borderRadius: BorderRadius.only(
                                topLeft: Radius.circular(10),
                                topRight: Radius.circular(10),
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        GestureDetector(
                          onTap: (){
                            trackCustomerController.goToListScreen("current_month_unbilled_customer");
                          },
                          child: Container(
                            padding: EdgeInsets.symmetric(vertical: 10.0,horizontal: 20.0),
                            decoration: BoxDecoration(
                  ...
                  Stack(
                    children: [
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                            gradient: LinearGradient(
                                colors: [trackcustomerpink, trackcustomeryellow.withOpacity(0.5)]),
                            border: Border.all(color: bordercolor1,width: 2.0),
                            borderRadius: BorderRadius.only(
                                topLeft: Radius.circular(10),
                                topRight: Radius.circular(10),
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        GestureDetector(
                          onTap: (){
                            trackCustomerController.goToListScreen("total_current_month_active_customer");
                          },
                          child: Container(
                            padding: EdgeInsets.symmetric(vertical: 10.0,horizontal: 20.0),
                            decoration: BoxDecoration(
                    ...
                    GestureDetector(
                      ...
                      child: Card(
                        ...
                        child: Padding(
                          ...
                          child: Image.asset(
                            'assets/images/journeyplannew.png',
                            height: 30.0,
                          ),
                        ),
                      ),
                          ...
                          Expanded(
                            child: Column(
                              children: [
                                ...
                                Obx(
                                      () => NumberPicker(
                                        textStyle: TextStyle(fontFamily: "Gilroy",color: Colors.black),
                                    selectedTextStyle:TextStyle(fontFamily: "Gilroy",color: startjourneyblue,fontWeight: FontWeight.w600,fontSize: 20.0),
                                    infiniteLoop: true,
