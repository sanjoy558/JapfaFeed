...
class GoodsReceivedCustomerController extends GetxController {
  ...
  void getCustomerList() {
    ...
    //.executeWithBearerTokenGET('api/pending-delivery', tokenid!)
    ApiService()
      ...
      if (response.statusCode == 200) {
        ...
        if (response.body != null) {
          ...
          MainPresenter.getInstance()
              .printLog("customerlist1", pendingGoodsList.value.length);
        } else {
          displayLoading.value = false;
    ...
    if (playerName.isEmpty) {
      results = pendingGoodsListDistinct.value;
        ...
        results = pendingGoodsListDistinct.value
            ...
            .toString()
            .toLowerCase()
            .contains(playerName.toLowerCase()) || item.pono
            .toString()
            .toLowerCase()
